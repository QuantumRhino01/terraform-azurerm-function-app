locals {
  ...
  function_outbound_ips = var.function_app_vnet_integration_subnet_id == null ? distinct(concat(split(",",azurerm_windows_function_app.windows_function.possible_outbound_ip_addresses), split(",", azurerm_windows_function_app.windows_function.outbound_ip_addresses))) : []
